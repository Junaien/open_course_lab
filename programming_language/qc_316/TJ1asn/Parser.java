...
public final class Parser {
  ...
  private static void accept (Symbols expectedToken) throws 
SourceFileErrorException
  {
    if (getCurrentToken() == expectedToken)
      nextToken();
    else throw new SourceFileErrorException("Something's wrong--maybe the 
following token is missing: "
  ...
  private static void varDecl() throws SourceFileErrorException
  {
    ...
    else throw new SourceFileErrorException("\"int\" or \"Scanner\" 
expected");
    TJ.output.decTreeDepth();
  }
  ...
  private static void methodDecl() throws SourceFileErrorException
  {
    ...
    if(getCurrentToken() == STATIC){
      ...
      }else throw new SourceFileErrorException("\"int\" or \"void\" 
expected");
  ...
  private static void statement() throws SourceFileErrorException
  {
    ...
    switch (getCurrentToken()) {
      ...
      default: throw new SourceFileErrorException("Expected first token of a 
<statement>, not "
                              + 
getCurrentToken().symbolRepresentationForOutputFile);
  ...
  private static void assignmentOrInvoc() throws SourceFileErrorException
  {
    ...
    }else throw new SourceFileErrorException("Variable name or method name 
expected");
    TJ.output.decTreeDepth();
  }
  ...
  private static void outputStmt() throws SourceFileErrorException
  {
    ...
    switch (getCurrentToken()) {
      ...
      default: throw new SourceFileErrorException("print() or println() 
expected, not "
                              + 
getCurrentToken().symbolRepresentationForOutputFile);
      */
